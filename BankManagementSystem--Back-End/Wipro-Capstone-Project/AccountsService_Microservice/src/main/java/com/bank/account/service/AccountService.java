...
public class AccountService {
    ...
    public Account saveAccount(Account account) {
        ...
        if (customer == null) throw new RuntimeException("Customer details not found. Cannot create account.");
        if((customer.getKyc()).equalsIgnoreCase("false") ){
    ...
    public void debitByBankNumber(String bankNumber, Double amount) {
        Account acc = repository.findByBankAccountNumber(bankNumber)
    ...
    public void creditByBankNumber(String bankNumber, Double amount) {
        Account acc = repository.findByBankAccountNumber(bankNumber)
                .orElseThrow(() -> new RuntimeException("Account not found"));
        acc.setBalance(acc.getBalance() + amount);
        repository.save(acc);
